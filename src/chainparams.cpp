...
static Checkpoints::MapCheckpoints mapCheckpoints = 
	...
	(0, uint256("0x00000877bc174e22a23f933af4aa38607300b0720301c407f6cb6a70428c8049"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1564245175, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("0x00000877bc174e22a23f933af4aa38607300b0720301c407f6cb6a70428c8049"));
...
public:
	...
	//vTreasuryRewardAddress="DKv8dUifgBKkWM1nwjad7yNasQ41yA9ntR";
        ...
        nMaxMoneyOut = 44000000000 * COIN; //40 Bill
      ...
      //  nSupplyBeforeFakeSerial = 4131563 * COIN;   // zerocoin supply at block nFakeSerialBlockheightEnd
        ...
        const char* pszTimestamp = "Pictureex Repowered Launch - akshaynexus - Liquid369";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1564245175; 
        genesis.nBits = 0x1e0ffff0;
	genesis.nNonce = 47300; 

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000877bc174e22a23f933af4aa38607300b0720301c407f6cb6a70428c8049")); 
        assert(genesis.hashMerkleRoot == uint256("0x353c5a12a087b82dd6a437e9d9facd10ca6e6b28e8938cf266adf24bd85b3697")); 

	vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("199.247.29.91", "199.247.29.91"));
        vSeeds.push_back(CDNSSeedData("45.63.119.149", "45.63.119.149"));
        vSeeds.push_back(CDNSSeedData("45.77.167.10", "45.77.167.10"));
	...
	base58Prefixes[EXT_SECRET_KEY] = list_of(0x02)(0x21)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x90)(0x00)(0xac).convert_to_container<std::vector<unsigned char> >();
